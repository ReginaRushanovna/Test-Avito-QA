...
def test_second_case():
    ...
    sleep(2)
    # login_input.send_keys('PLACE_FOR_LOGIN')  # ввод тестового логина в поле "Телефон или почта"
    sleep(2)
    ...
    sleep(2)
    #password_input.send_keys('PLACE_FOR_PASSWORD') # ввод тестового пароля в поле "Пароль"
    sleep(2)
